              ...
              >
                <View className="flex-1 justify-center items-center">
                  <View className="w-[52] rounded-[12px] h-[52] mb-10 bg-primary justify-center items-center">
                    <FontAwesome name="envelope" size={28} color={"#ffffff"} />
                  </View>
                  ...
                  <Text className="text-gray-500 text-center mt-3 mb-6">
                    To verify your account, enter the 6 digit OTP code that we
                    sent to your email.
                  </Text>
                  ...
                  <View className="w-full bottom-2 mt-4 left-0 right-0 px-4 z-20">
                    {/* Verify Button */}
                    <TouchableOpacity
